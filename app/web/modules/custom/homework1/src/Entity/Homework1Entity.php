...
namespace Drupal\homework1\Entity;

use Drupal\Core\Entity\EntityStorageInterface;
use Drupal\Core\Field\BaseFieldDefinition;
use Drupal\Core\Entity\ContentEntityBase;
use Drupal\Core\Entity\EntityTypeInterface;
use Drupal\homework1\Homework1EntityInterface;
 ...
 *   You can see this in the entity.homework1_homework1entity.canonical
 *   route in the homework1.routing.yml file. The view can be
 ...
 *
 * @ContentEntityType(
 *   id = "homework1_homework1entity",
 *   label = @Translation("Homework1 entity"),
 *   handlers = {
 *     "view_builder" = "Drupal\Core\Entity\EntityViewBuilder",
 *     "list_builder" = "Drupal\homework1\Entity\Controller\Homework1EntityListBuilder",
 *     "form" = {
 *       "default" = "Drupal\homework1\Form\Homework1EntityForm",
 *       "delete" = "Drupal\homework1\Form\Homework1EntityDeleteForm",
 *     },
 *     "access" = "Drupal\homework1\Homework1EntityAccessControlHandler",
 *   },
 *   list_cache_contexts = { "user" },
 *   base_table = "homework1entity",
 *   admin_permission = "administer homework1entity entity",
 *   entity_keys = {
 *     "id" = "id",
 *     "label" = "name",
 *     "uuid" = "uuid"
 *   },
 *   links = {
 *     "canonical" = "/homework1_homework1entity/{homework1_homework1entity}",
 *     "edit-form" = "/homework1_homework1entity/{homework1_homework1entity}/edit",
 *     "delete-form" = "/homework1entity/{homework1_homework1entity}/delete",
 *     "collection" = "/homework1_homework1entity/list"
 *   },
 *   field_ui_base_route = "homework1.homework1entity_settings",
 * )
 *
 ...
 *
 * Example: 'entity.homework1_homework1entity.canonical'.
 *
 * See the routing file at homework1.routing.yml for the
 * corresponding implementation.
 *
 * The Homework1Entity class defines methods and fields for the homework1entity entity.
 *
 * Being derived from the ContentEntityBase class, we can override the methods
 * we want. In our case we want to provide access to the standard fields about
 * creation and changed time stamps.
 *
 * Our interface (see Homework1EntityInterface) also exposes the EntityOwnerInterface.
 ...
 */
class Homework1Entity extends ContentEntityBase implements Homework1EntityInterface {
...
//      'type' => 'custom_content_type' @TODO investigate this
    ];
  }
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['id'] = BaseFieldDefinition::create('integer')
      ->setLabel(t('ID'))
      ->setDescription(t('The ID of the Homework1Entity entity.'))
      ->setReadOnly(TRUE);

    // Standard field, unique outside of the scope of the current project.
    $fields['uuid'] = BaseFieldDefinition::create('uuid')
      ->setLabel(t('UUID'))
      ->setDescription(t('The UUID of the Homework1Entity entity.'))
      ->setReadOnly(TRUE);

    // Name field for the homework1entity.
    // We set display options for the view as well as the form.
    // Users with correct privileges can change the view and edit configuration.
    $fields['name'] = BaseFieldDefinition::create('string')
      ->setLabel(t('Name'))
      ->setDescription(t('The name of the Homework1Entity entity.'))
      ->setSettings([
        'max_length' => 255,
        'text_processing' => 0,
      ])
    ...
    $fields['first_name'] = BaseFieldDefinition::create('string')
      ...
      ->setDescription(t('The first name of the Homework1Entity entity.'))
      ->setSettings([
        'max_length' => 255,
        'text_processing' => 0,
      ])
    ...
    // Owner field of the homework1entity.
